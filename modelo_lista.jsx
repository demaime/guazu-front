...
export default function GuazuRedesign() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 relative">
          ...
          <div className="p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <span className="absolute right-0 -top-5 text-xs font-semibold text-gray-400">
                  35%
                </span>
              </div>
        ...
        <div className="bg-slate-800 rounded-2xl shadow-xl border border-slate-700 overflow-hidden">
          <div className="p-4">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <h3 className="font-semibold text-white mb-1">
                  Encuesta Municipal 2025
                </h3>
                <p className="text-xs text-gray-400">
                  Estudio de opinión ciudadana
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-semibold text-white">
                      8/50 <span className="text-xs text-gray-500">(16%)</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="fixed bottom-6 left-4 right-4 bg-slate-800 border border-slate-700 text-white rounded-xl p-3 shadow-xl">
        <div className="flex items-start gap-3">
          <CheckCircle2 className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
          <div className="flex-1 text-sm">
            <div className="font-semibold mb-0.5">
              Modo {isOnline ? "Online" : "Offline"} activo
            </div>
            <div className="text-xs text-gray-400">
              {isOnline
