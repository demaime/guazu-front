...
export default function PerfilPage() {
  ...
  const isFieldEditable = (fieldName) => {
    ...
    return user.editableFields.includes('all') || user.editableFields.includes(fieldName);
  };
  ...
  const renderField = (fieldName, label, type = 'text') => {
    ...
    return (
      <div className="space-y-1">
        <label htmlFor={fieldName} className="block text-sm font-medium text-[var(--text-secondary)]">
          {label}
          {!isEditable && (
              ...
              <div className="flex justify-end space-x-4 mt-6">
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium text-[var(--text-primary)] bg-[var(--button-secondary)] rounded-md transition-colors ${
                    !hasUnsavedChanges ? 'opacity-50 cursor-not-allowed' : 'hover:bg-opacity-80'
                  }`}
                >
                  Cancelar
                </button>
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium text-white bg-primary rounded-md transition-colors ${
                    !hasUnsavedChanges || isSaving ? 'opacity-50 cursor-not-allowed' : 'hover:bg-primary-dark'
                  }`}
                >
          ...
          >
            ...
            >
              <h3 className="text-lg font-medium text-gray-900 mb-4">
                {modalAction === 'save' ? '¿Guardar cambios?' : '¿Descartar cambios?'}
              </h3>
